...
sort highest to lowest balance. NOTE: Research LIMIT
    ...
    SELECT "username", "account_balance" FROM syntax_practice ORDER BY
    "account_balance" DESC LIMIT 3;

6. Get the username and account balance of the 3 users with the lowest balances,
sort lowest to highest balance.

    SELECT "username", "account_balance" FROM syntax_practice ORDER BY
    "account_balance" ASC LIMIT 3;
...
8. Add a new record.
    ...
    "transactions_attempted", "account_balance")VALUES('claudia',
    'bloomington', 10, 3, 3200000.84);
...
have completed fewer than 5 transactions.
    ...
    DELETE FROM "syntax_practice" WHERE ("city" = 'miami' OR "city"
    = 'phoenix') AND "transactions_completed" < 5;
